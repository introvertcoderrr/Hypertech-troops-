...
public class login extends JFrame implements ActionListener
{
    ...
    login()
    {
        ...
        l2.setBounds(120, 120, 150, 30);  // Use l2, not l1 here
        ...
        l3.setBounds(190,30,500,50);  // Use l2, not l1 here
        l3.setForeground(Color.BLACK);
        l3.setFont(new Font("Arial", Font.BOLD, 30));
        l1.add(l3);
        
        l4 = new JLabel("Password");
        l4.setBounds(120, 170, 150, 30);  // Use l2, not l1 here
        ...
        bt2.setBackground(Color.BLACK);  // Use l2, not l1 here
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                {
                    JOptionPane.showMessageDialog(null,"you have enetred wrong username and password!");
                    f.setVisible(false);
                    f.setVisible(true);
                }
            }
